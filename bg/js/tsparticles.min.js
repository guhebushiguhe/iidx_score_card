    ...
    function(t, i, e) {
      ...
      class n {
        ...
        static isPointInside(t, i, e) {
          return this.areBoundsInside(
            this.calculateBounds(t, null != e ? e : 0),
            i
          );
        }
        static areBoundsInside(t, i) {
          return (
            t.left < i.width && t.right > 0 && t.top < i.height && t.bottom > 0
          );
        }
        ...
        static deepExtend(t, i) {
          ...
          for (const o in i)
            i[o] && i[o].constructor && i[o].constructor === Object
              ? ((t[o] = null !== (e = t[o]) && void 0 !== e ? e : {}),
                n.deepExtend(t[o], i[o]))
              : (t[o] = i[o]);
          return t;
        }
      }
      let a = (() => {
        class t {}
        return (
          (t.canvasClass = "tsparticles-canvas-el"),
      ...
      class r {
        static colorToRgb(t) {
          var i, e;
          if (void 0 === t) return;
          const o = "string" == typeof t ? { value: t } : t;
          let s;
          if ("string" == typeof o.value)
            s =
              o.value === a.randomColorValue
                ? {
        ...
        static stringToAlpha(t) {
          var i;
          return null === (i = r.stringToRgba(t)) || void 0 === i
            ? void 0
            : i.a;
        }
        ...
        static getRandomRgbColor(t) {
          ...
          return null !== (i = this.stringToRgb("#" + n)) && void 0 !== i
            ? i
            : { b: 0, g: 0, r: 0 };
        }
        ...
        static stringToRgba(t) {
          if (t.startsWith("rgb")) {
            const i = /rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(,\s*([\d.]+)\s*)?\)/i.exec(
              t
            );
            return i
              ? {
          ...
          if (t.startsWith("hsl")) {
            const i = /hsla?\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(,\s*([\d.]+)\s*)?\)/i.exec(
              t
            );
            return i
              ? r.hslaToRgba({
      ...
      class l {
        ...
        static drawLinkLine(t, i, e, o, s, a, l, c, h, d, u) {
          if (n.getDistance(e, o) <= s) this.drawLine(t, e, o);
          else if (l) {
            let i, r;
            const l = { x: o.x - a.width, y: o.y },
              { dx: c, dy: h, distance: d } = n.getDistances(e, l);
            if (d <= s) {
              const t = e.y - (h / c) * e.x;
              (i = { x: 0, y: t }), (r = { x: a.width, y: t });
            } else {
              const t = { x: o.x, y: o.y - a.height },
                { dx: l, dy: c, distance: h } = n.getDistances(e, t);
              if (h <= s) {
                const t = -(e.y - (c / l) * e.x) / (c / l);
                (i = { x: t, y: 0 }), (r = { x: t, y: a.height });
              } else {
                const t = { x: o.x - a.width, y: o.y - a.height },
                  { dx: l, dy: c, distance: h } = n.getDistances(e, t);
                if (h <= s) {
                  const t = e.y - (c / l) * e.x;
                  (i = { x: -t / (c / l), y: t }),
                    (r = { x: i.x + a.width, y: i.y + a.height });
                }
              }
            }
            i && r && (this.drawLine(t, e, i), this.drawLine(t, o, r));
          }
          if (
            ((t.lineWidth = i),
            ...
            i &&
              ((t.shadowBlur = u.blur), (t.shadowColor = r.getStyleFromRgb(i)));
          }
          t.stroke();
        }
        ...
        static drawParticle(t, i, e, o, s, n, a, l, c) {
          ...
          u.width > 0 &&
            e.strokeColor &&
            ((i.strokeStyle = r.getStyleFromRgb(
              e.strokeColor,
              e.stroke.opacity
            )),
            (i.lineWidth = u.width)),
      ...
      class d extends c {
        ...
        contains(t) {
          return (
            t.x >= this.position.x - this.size.width &&
            t.x < this.position.x + this.size.width &&
      ...
      class m {
        ...
        manageListeners(t) {
          ...
          o === v.window
            ...
            : o === v.parent && i.canvas.element
            ? (i.interactivity.element = i.canvas.element.parentNode)
          ...
          s &&
            ...
            e.interactivity.events.resize &&
              m.manageListener(window, a.resizeEvent, this.resizeHandler, t),
            document &&
              m.manageListener(
                document,
        ...
        handleWindowResize() {
          ...
          if (e) {
            (t.canvas.size.width = e.offsetWidth),
              ...
              t.retina.isRetina &&
                ((t.canvas.size.width *= t.retina.pixelRatio),
        ...
        mouseTouchMove(t) {
          ...
          if (t.type.startsWith("mouse")) {
            ...
            if (
              void 0 ===
              (null === (i = s.interactivity) || void 0 === i
                ? void 0
                : i.element)
            )
              return;
            if (s.interactivity.element === window) {
              ...
              if (t && i) {
                ...
                r = { x: e.offsetX || e.clientX, y: e.offsetY || e.clientY };
            } else
              e.target === s.canvas.element &&
                (r = { x: e.offsetX || e.clientX, y: e.offsetY || e.clientY });
          } else {
            ...
            r = {
              x:
                s.clientX -
                (null !== (e = null == n ? void 0 : n.left) && void 0 !== e
                  ? e
                  : 0),
              y:
                s.clientY -
                (null !== (o = null == n ? void 0 : n.top) && void 0 !== o
                  ? o
                  : 0),
            };
          }
          s.retina.isRetina &&
            r &&
            ((r.x *= s.retina.pixelRatio), (r.y *= s.retina.pixelRatio)),
        ...
        mouseTouchClick(t) {
          ...
          if (void 0 !== s && e.interactivity.events.onClick.enable) {
            for (const t in i.plugins) {
              const e = i.plugins[t];
              if (
                void 0 !== e.clickPositionValid &&
                ((o = e.clickPositionValid(s)), o)
              )
                break;
            }
        ...
        handleClickMode(t) {
          ...
          switch (t) {
            case p.push:
              o > 0 &&
                (e.particles.move.enable || 1 === o
                  ? i.particles.push(o, i.interactivity.mouse)
                  : o > 1 && i.particles.push(o));
              break;
            case p.remove:
      ...
      class g {
        constructor(t, i, e) {
          (this.position = { x: t, y: i }), (this.particle = e);
        }
      }
      class f {
        constructor(t, i) {
        ...
        subdivide() {
          ...
          (this.northEast = new f(new d(t, i, e / 2, o / 2), s)),
            ...
            (this.southWest = new f(
              new d(t + e / 2, i + o / 2, e / 2, o / 2),
              s
            )),
            (this.divided = !0);
        }
      ...
      class x {
        ...
        noise3D(t, i, e) {
          ...
          v >= m
            ? m >= y
              ? ((g = 1), (f = 0), (x = 0), (z = 1), (k = 1), (P = 0))
              : v >= y
              ? ((g = 1), (f = 0), (x = 0), (z = 1), (k = 0), (P = 1))
              : ((g = 0), (f = 0), (x = 1), (z = 1), (k = 0), (P = 1))
            : m < y
            ? ((g = 0), (f = 0), (x = 1), (z = 0), (k = 1), (P = 1))
            : v < y
            ? ((g = 0), (f = 1), (x = 0), (z = 0), (k = 1), (P = 1))
            : ((g = 0), (f = 1), (x = 0), (z = 1), (k = 1), (P = 0));
          const S = v - g + b,
            M = m - f + b,
            O = y - x + b,
            A = v - z + 2 * b,
            ...
            I = 255 & d,
            L = 255 & u;
          let _ = 0.6 - v * v - m * m - y * y;
          if (_ < 0) n = 0;
          else {
            const t = 3 * o[V + s[I + s[L]]];
            (_ *= _), (n = _ * _ * (w[t] * v + w[t + 1] * m + w[t + 2] * y));
          }
          let H = 0.6 - S * S - M * M - O * O;
          if (H < 0) a = 0;
          else {
            const t = 3 * o[V + g + s[I + f + s[L + x]]];
            (H *= H), (a = H * H * (w[t] * S + w[t + 1] * M + w[t + 2] * O));
          }
          let F = 0.6 - A * A - C * C - T * T;
          if (F < 0) r = 0;
          else {
            const t = 3 * o[V + z + s[I + k + s[L + P]]];
            (F *= F), (r = F * F * (w[t] * A + w[t + 1] * C + w[t + 2] * T));
          }
          let B = 0.6 - R * R - E * E - D * D;
          if (B < 0) l = 0;
          else {
            const t = 3 * o[V + 1 + s[I + 1 + s[L + 1]]];
            (B *= B), (l = B * B * (w[t] * R + w[t + 1] * E + w[t + 2] * D));
          }
          return 32 * (n + a + r + l);
        }
      }
      class z {
        constructor(t, i, e) {
          ...
          const c =
              "boolean" == typeof i.size.random
                ? i.size.random
                : i.size.random.enable,
            h =
              "boolean" == typeof i.size.random
                ? 1
                : i.size.random.minimumValue;
          ...
          (this.color =
            null !== (o = r.colorToRgb(u)) && void 0 !== o
              ? o
              : { b: 0, g: 0, r: 0 }),
            (this.position =
        ...
        attract(t, i) {
          ...
          if (a < this.size + t.size.value) {
            const i = 0.033 * t.size.value;
            this.size > t.size.value && a < this.size - t.size.value
              ? (t.destroyed = !0)
              : ((t.size.value -= i),
        ...
        resize() {
          ...
          this.position =
            t && n.isPointInside(t, this.container.canvas.size)
              ? t
              : this.calcPosition();
        }
        draw(t) {
        ...
        calcPosition() {
          ...
          const i = this.container,
            e =
              null !== (t = this.options.position) && void 0 !== t
                ? t
      ...
      class k {
        ...
        particleUpdate(t, i) {
          for (const e of this.array) if ((e.attract(t, i), t.destroyed)) break;
        }
        draw(t) {
        ...
        handleClickMode(t) {
          ...
          if (t === p.absorber) {
            ...
            o instanceof Array
              ? o.length > 0 && (t = n.itemFromArray(o))
              : (t = o);
            const s =
                null != t
                  ? t
                  : e.absorbers instanceof Array
                  ? n.itemFromArray(e.absorbers)
                  : e.absorbers,
            ...
            if (h.enable)
              if (s.lastNoiseTime > s.noiseDelay) {
                const t = s.position,
                  ...
                  a = {
                    angle: o.noise3D(
                      F.calcNoiseValue(t.x, s.size.value, i.horizontal),
                      F.calcNoiseValue(t.y, s.size.value, i.horizontal),
                      e.particles.noiseZ
                    ),
                    length: o.noise3D(
                      F.calcNoiseValue(t.x, s.size.value, i.vertical),
                      F.calcNoiseValue(t.y, s.size.value, i.vertical),
                      e.particles.noiseZ
                    ),
                  };
                (s.velocity.horizontal += Math.cos(a.angle) * a.length),
                  (s.velocity.horizontal = n.clamp(
                    s.velocity.horizontal,
                    -1,
                    1
                  )),
      ...
      class B {
        constructor(t, i) {
          (this.container = t), (this.particle = i), (this.mover = new F(t, i));
        }
        ...
        updateOpacity(t) {
          ...
          if (e.particlesOptions.opacity.animation.enable) {
            switch (e.opacity.status) {
              case C.increasing:
                e.opacity.value >= e.particlesOptions.opacity.value
                  ? (e.opacity.status = C.decreasing)
                  : (e.opacity.value += (e.opacity.velocity || 0) * o);
                break;
              case C.decreasing:
                e.opacity.value <=
                e.particlesOptions.opacity.animation.minimumValue
                  ? (e.opacity.status = C.increasing)
                  : (e.opacity.value -= (e.opacity.velocity || 0) * o);
            }
        ...
        updateSize(t) {
          ...
          if (s.particlesOptions.size.animation.enable) {
            switch (s.size.status) {
              case A.increasing:
                s.size.value >=
                (null !== (i = s.sizeValue) && void 0 !== i
                  ? i
                  : e.retina.sizeValue)
                  ? (s.size.status = A.decreasing)
                  : (s.size.value += (s.size.velocity || 0) * n);
                break;
              case A.decreasing:
                s.size.value <= s.particlesOptions.size.animation.minimumValue
                  ? (s.size.status = A.increasing)
                  : (s.size.value -= (s.size.velocity || 0) * n);
            }
        ...
        updateAngle(t) {
          ...
          if (e.particlesOptions.rotate.animation.enable)
            switch (e.rotateDirection) {
              case O.clockwise:
                (e.angle +=
                  ((e.particlesOptions.rotate.animation.speed * Math.PI) / 18) *
                  o),
        ...
        fixOutOfCanvasPosition(t) {
          ...
          if (
            ...
            n.isPointInside(e.position, i.canvas.size, t) ||
              i.particles.remove(e);
          } else {
            const t = e.size.value,
              i = n.calculateBounds(e.position, t);
            i.left > a.width - e.offset.x
              ? ((e.position.x = r.left),
                s || (e.position.y = Math.random() * a.height))
              : i.right < -e.offset.x &&
                ((e.position.x = r.right),
                s || (e.position.y = Math.random() * a.height)),
              i.top > a.height - e.offset.y
                ? (s || (e.position.x = Math.random() * a.width),
                  (e.position.y = r.top))
                : i.bottom < -e.offset.y &&
                  (s || (e.position.x = Math.random() * a.width),
        ...
        updateBounce(t) {
          ...
          for (const s in i.plugins) {
            const n = i.plugins[s];
            if (
              (void 0 !== n.particleBounce && (o = n.particleBounce(e, t)), o)
            )
              break;
          }
          if (!o) {
      ...
      class X {
        constructor() {
          (this.random = new $()), (this.value = 0);
        }
        load(t) {
          var i;
          void 0 !== t &&
            (null === (i = this.random) || void 0 === i || i.load(t.random),
      ...
      class Y {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.value &&
              (this.value = 0 === t.value ? this.value : t.value),
      ...
      class Q {
        constructor() {
          (this.delay = new X()), (this.enable = !1), (this.factor = new J());
        }
        load(t) {
          void 0 !== t &&
      ...
      class tt {
        constructor() {
          (this.density = new K()), (this.limit = 0), (this.value = 100);
        }
        get max() {
          return this.limit;
        }
      ...
      class rt extends st {
        ...
        load(t) {
          super.load(t),
            void 0 !== t &&
              (void 0 !== t.font && (this.font = t.font),
        ...
        load(t) {
          ...
          if (void 0 !== t) {
            ...
            if (void 0 !== t.character) {
              ...
              void 0 !== i &&
                (i instanceof Array
                  ? this.options[P.character] instanceof Array
                    ? ((this.options[P.character] = n.deepExtend(
                        null !== (o = this.options[P.character]) && void 0 !== o
                          ? o
                          : [],
                        i
                      )),
                      (this.options[P.char] = n.deepExtend(
                        null !== (s = this.options[P.char]) && void 0 !== s
                          ? s
                          : [],
                        i
                      )))
                    : ((this.options[P.character] = n.deepExtend([], i)),
                      (this.options[P.char] = n.deepExtend([], i)))
                  : this.options[P.character] instanceof Array
                  ? ((this.options[P.character] = n.deepExtend({}, i)),
                    (this.options[P.char] = n.deepExtend({}, i)))
                  : ((this.options[P.character] = n.deepExtend(
                      null !== (a = this.options[P.character]) && void 0 !== a
                        ? a
                        : [],
                      i
                    )),
                    (this.options[P.char] = n.deepExtend(
                      null !== (r = this.options[P.char]) && void 0 !== r
                        ? r
                        : [],
                      i
                    ))));
            ...
            if (void 0 !== t.polygon) {
              ...
              void 0 !== i &&
                (i instanceof Array
                  ? this.options[P.polygon] instanceof Array
                    ? ((this.options[P.polygon] = n.deepExtend(
                        null !== (l = this.options[P.polygon]) && void 0 !== l
                          ? l
                          : [],
                        i
                      )),
                      (this.options[P.star] = n.deepExtend(
                        null !== (c = this.options[P.star]) && void 0 !== c
                          ? c
                          : [],
                        i
                      )))
                    : ((this.options[P.polygon] = n.deepExtend([], i)),
                      (this.options[P.star] = n.deepExtend([], i)))
                  : this.options[P.polygon] instanceof Array
                  ? ((this.options[P.polygon] = n.deepExtend({}, i)),
                    (this.options[P.star] = n.deepExtend({}, i)))
                  : ((this.options[P.polygon] = n.deepExtend(
                      null !== (h = this.options[P.polygon]) && void 0 !== h
                        ? h
                        : [],
                      i
                    )),
                    (this.options[P.star] = n.deepExtend(
                      null !== (d = this.options[P.star]) && void 0 !== d
                        ? d
                        : [],
                      i
                    ))));
            ...
            if (void 0 !== t.image) {
              ...
              void 0 !== i &&
                (i instanceof Array
                  ? this.options[P.image] instanceof Array
                    ? ((this.options[P.image] = n.deepExtend(
                        null !== (u = this.options[P.image]) && void 0 !== u
                          ? u
                          : [],
                        i
                      )),
                      (this.options[P.images] = n.deepExtend(
                        null !== (p = this.options[P.images]) && void 0 !== p
                          ? p
                          : [],
                        i
                      )))
                    : ((this.options[P.image] = n.deepExtend([], i)),
                      (this.options[P.images] = n.deepExtend([], i)))
                  : this.options[P.image] instanceof Array
                  ? ((this.options[P.image] = n.deepExtend({}, i)),
                    (this.options[P.images] = n.deepExtend({}, i)))
                  : ((this.options[P.image] = n.deepExtend(
                      null !== (v = this.options[P.image]) && void 0 !== v
                        ? v
                        : [],
                      i
                    )),
                    (this.options[P.images] = n.deepExtend(
                      null !== (m = this.options[P.images]) && void 0 !== m
                        ? m
                        : [],
                      i
                    ))));
      ...
      class yt {
        constructor() {
          (this.enable = !1), (this.mode = D.bounce);
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.enable && (this.enable = t.enable),
      ...
      class ft {
        constructor() {
          (this.lines = new gt()), (this.particles = new gt());
        }
        load(t) {
          void 0 !== t &&
      ...
      class zt {
        constructor(t, i, e) {
          ...
          const S = t.options,
            M = new xt();
          if (
            (M.load(S.particles), void 0 !== (null == e ? void 0 : e.shape))
          ) {
            const t =
              null !== (o = e.shape.type) && void 0 !== o ? o : M.shape.type;
            this.shape = t instanceof Array ? n.itemFromArray(t) : t;
            const i = new lt();
            if ((i.load(e.shape), void 0 !== this.shape)) {
              const t = i.options[this.shape];
              void 0 !== t &&
                ((this.shapeData = n.deepExtend(
                  {},
                  t instanceof Array ? n.itemFromArray(t) : t
                )),
                (this.fill =
                  null !==
                    (a =
            ...
            i &&
              ((this.shapeData = n.deepExtend(
                {},
                i instanceof Array ? n.itemFromArray(i) : i
              )),
              (this.fill =
                null !==
                  (d =
          ...
          (this.noiseDelay =
            1e3 *
            (E.random.enable
              ? n.randomInRange(E.random.minimumValue, E.value)
              : E.value)),
            t.retina.initParticle(this);
          const D = this.particlesOptions.color,
            V =
              null !== (b = this.sizeValue) && void 0 !== b
                ? b
                : t.retina.sizeValue,
            I =
              "boolean" == typeof this.particlesOptions.size.random
                ? this.particlesOptions.size.random
                : this.particlesOptions.size.random.enable;
          if (
            ((this.size = {
              value:
                I && void 0 !== this.randomMinimumSize
                  ? n.randomInRange(this.randomMinimumSize, V)
                  : V,
            }),
            ...
            switch (this.particlesOptions.size.animation.startValue) {
              case R.min:
                if (!I) {
                  ...
                  this.size.value =
                    this.particlesOptions.size.animation.minimumValue * i;
                }
            }
            (this.size.status = A.increasing),
              (this.size.velocity =
                (null !== (w = this.sizeAnimationSpeed) && void 0 !== w
                  ? w
                  : t.retina.sizeAnimationSpeed) / 100),
              this.particlesOptions.size.animation.sync ||
                (this.size.velocity = this.size.velocity * Math.random());
          }
          this.particlesOptions.color.animation.enable
            ? ((this.colorVelocity =
                this.particlesOptions.color.animation.speed / 100),
              this.particlesOptions.color.animation.sync ||
                (this.colorVelocity = this.colorVelocity * Math.random()))
            : (this.colorVelocity = 0),
            this.particlesOptions.rotate.animation.enable &&
              (this.particlesOptions.rotate.animation.sync ||
                (this.angle = 360 * Math.random())),
            (this.position = this.calcPosition(this.container, i)),
            S.polygon.enable &&
              S.polygon.type === T.inline &&
          ...
          (this.opacity = {
            ...
            this.particlesOptions.opacity.animation.enable &&
              ((this.opacity.status = C.increasing),
              (this.opacity.velocity =
                this.particlesOptions.opacity.animation.speed / 100),
              this.particlesOptions.opacity.animation.sync ||
          ...
          if (
            (H ||
              ((H = y.getShapeDrawer(this.shape)), (t.drawers[this.shape] = H)),
            ...
            const i = H,
              ...
              a =
                e instanceof Array ? e.filter((t) => t.src === s.source)[0] : e;
            (this.image = {
              data: s,
              ratio: a.width / a.height,
              replaceColor:
                null !== (x = a.replaceColor) && void 0 !== x
                  ? x
                  : a.replace_color,
              source: a.src,
            }),
        ...
        isOverlapping() {
          ...
          return { collisionFound: i, iterations: e };
        }
        checkOverlap(t) {
          const i = this.container,
            e = this.isOverlapping();
          e.iterations >= i.particles.count
            ? i.particles.remove(this)
            : e.collisionFound &&
              ((this.position.x = t
                ? t.x
                : Math.random() * i.canvas.size.width),
              (this.position.y = t
                ? t.y
                : Math.random() * i.canvas.size.height),
              this.checkOverlap());
        }
        startInfection(t) {
        ...
        calcPosition(t, i) {
          for (const e in t.plugins) {
            const o = t.plugins[e],
              s =
                void 0 !== o.particlePosition ? o.particlePosition(i) : void 0;
            if (void 0 !== s) return s;
          }
          const e = { x: 0, y: 0 };
          return (
            (e.x = i ? i.x : Math.random() * t.canvas.size.width),
            (e.y = i ? i.y : Math.random() * t.canvas.size.height),
            e.x > t.canvas.size.width - 2 * this.size.value
              ? (e.x -= this.size.value)
              : e.x < 2 * this.size.value && (e.x += this.size.value),
            e.y > t.canvas.size.height - 2 * this.size.value
              ? (e.y -= this.size.value)
              : e.y < 2 * this.size.value && (e.y += this.size.value),
            e
          );
        }
        calculateVelocity() {
          ...
          return (
            this.particlesOptions.move.straight
              ? ((i.horizontal = t.x),
                (i.vertical = t.y),
                this.particlesOptions.move.random &&
                  ((i.horizontal *= Math.random()),
                  (i.vertical *= Math.random())))
              : ((i.horizontal = t.x + Math.random() - 0.5),
                (i.vertical = t.y + Math.random() - 0.5)),
            i
          );
        }
      }
      ...
      class Pt {
        constructor(t, i, e) {
          ...
          (this.emitters = t),
            ...
            (this.position =
              null !== (o = this.initialPosition) && void 0 !== o
                ? o
                : this.calcPosition());
          ...
          void 0 === r && (r = {}),
            ...
            (this.size =
              null !== (s = this.emitterOptions.size) && void 0 !== s
                ? s
                : (() => {
                    const t = new kt();
                    return t.load({ height: 0, width: 0, mode: V.percent }), t;
                  })()),
            (this.lifeCount =
                ...
                this.lifeCount > 0
                  ? ((this.position = this.calcPosition()),
                    window.setTimeout(
                      ...
                      null !== (t = this.emitterOptions.life.delay) &&
                        void 0 !== t
                        ? t
                        : 0
                    ))
        ...
        calcPosition() {
          ...
          const i = this.container,
            e =
              null !== (t = this.emitterOptions.position) && void 0 !== t
                ? t
                : { x: 100 * Math.random(), y: 100 * Math.random() };
          return {
            x: (e.x / 100) * i.canvas.size.width,
        ...
        emit() {
          ...
          for (let s = 0; s < this.emitterOptions.rate.quantity; s++) {
            const s = new zt(
              t,
              {
                x: i.x + e * (Math.random() - 0.5),
                y: i.y + o * (Math.random() - 0.5),
              },
      ...
      class Mt {
        constructor(t) {
          (this.container = t),
            ...
            (this.paths = []),
            (this.path2DSupported = Object.prototype.hasOwnProperty.call(
              window,
              "Path2D"
            ));
        }
        static polygonBounce(t) {
          (t.velocity.horizontal =
            -t.velocity.horizontal + t.velocity.vertical / 2),
            (t.velocity.vertical =
              -t.velocity.vertical + t.velocity.horizontal / 2);
        }
        ...
        static drawPolygonMaskPath(t, i, e, o) {
          ...
          s &&
            ((t.strokeStyle = r.getStyleFromRgb(s, e.opacity)),
            (t.lineWidth = e.width),
            t.stroke(i));
        }
        checkInsidePolygon(t) {
          ...
          if (
            !e.polygon.enable ||
            e.polygon.type === T.none ||
            e.polygon.type === T.inline
          )
            return !0;
          ...
          return e.polygon.type === T.inside
            ? n
            : e.polygon.type === T.outside && !n;
        }
        resize() {
          const t = this.container,
            i = t.options;
          i.polygon.enable &&
            i.polygon.type !== T.none &&
            (this.redrawTimeout && clearTimeout(this.redrawTimeout),
            (this.redrawTimeout = window.setTimeout(() => {
              this.parseSvgPathToPolygon().then((i) => {
                (this.raw = i), this.createPath2D(), t.particles.redraw();
              });
            }, 250)));
        }
        startAsync() {
          return o(this, void 0, void 0, function*() {
            ...
            t.polygon.enable &&
              t.polygon.url &&
              ((this.raw = yield this.parseSvgPathToPolygon(t.polygon.url)),
              this.createPath2D());
          });
        }
        stop() {
          ...
          if (i.polygon.type === T.inline)
            switch (i.polygon.inline.arrangement) {
              ...
              case I.randomLength:
                ...
                break;
              case I.equidistant:
                e = this.getEquidistantPointOnPolygonPathByIndex(
                  t.particles.count
                );
                break;
              case I.onePerPoint:
        ...
        particlesInitialization() {
          ...
          return (
            !(
              !t.polygon.enable ||
              t.polygon.type !== T.inline ||
              (t.polygon.inline.arrangement !== I.onePerPoint &&
                t.polygon.inline.arrangement !== I.perPoint)
        ...
        particlePosition(t) {
          var i, e;
          if (
            this.container.options.polygon.enable &&
            (null !==
              (e =
                null === (i = this.raw) || void 0 === i ? void 0 : i.length) &&
            void 0 !== e
              ? e
              : 0) > 0
          ) {
            const i = { x: 0, y: 0 };
            if (t) (i.x = t.x), (i.y = t.y);
            else {
        ...
        particleBounce(t, i) {
          ...
          if (
            o.polygon.enable &&
            o.polygon.type !== T.none &&
            o.polygon.type !== T.inline
          ) {
            if (!this.checkInsidePolygon(t.getPosition()))
              return Mt.polygonBounce(t), !0;
          } else if (
            o.polygon.enable &&
            o.polygon.type === T.inline &&
            t.initialPosition
            ...
            if (
              n.getDistance(t.initialPosition, t.getPosition()) >
              e.retina.polygonMaskMoveRadius
            )
              return Mt.polygonBounce(t), !0;
          }
          return !1;
        ...
        parseSvgPathToPolygon(t) {
          ...
          return o(this, void 0, void 0, function*() {
            ...
            (this.dimension.width =
              parseFloat(this.svg.getAttribute("width") || "0") * a),
              (this.dimension.height =
                parseFloat(this.svg.getAttribute("height") || "0") * a);
            const r =
              null !== (i = o.polygon.position) && void 0 !== i
                ? i
                : { x: 50, y: 50 };
            this.offset = {
              x:
                (e.canvas.size.width * r.x) / (100 * n) -
                this.dimension.width / 2,
              y:
                (e.canvas.size.height * r.y) / (100 * n) -
        ...
        draw(t) {
          ...
          if (i.polygon.enable && i.polygon.draw.enable) {
            ...
            for (const o of this.paths) {
              ...
              t &&
                (n && s && this.offset
                  ? Mt.drawPolygonMaskPath(t, s, i.stroke, this.offset)
                  : e && Mt.drawPolygonMask(t, e, i.stroke));
            }
          }
        }
          ...
          if (this.path2DSupported)
            for (const i of this.paths) {
              ...
              if (e) {
                ...
                s.addPath ? (s.addPath(t, n), (i.path2d = s)) : delete i.path2d;
      ...
      class Ot {
        ...
        paint() {
          ...
          this.context &&
            ...
            this.coverColor
              ? this.paintBase(r.getStyleFromRgb(this.coverColor))
              : this.paintBase());
        }
        clear() {
          const t = this.container.options,
          ...
          t.backgroundMask.enable
            ...
            ? this.paintBase(
                r.getStyleFromRgb(this.trailFillColor, 1 / i.length)
              )
            : this.context && l.clear(this.context, this.size);
        }
        isPointInPath(t, i) {
        ...
        drawLinkLine(t, i) {
          ...
          if (v.enable) {
            ...
            Math.random() < t && void 0 !== i && ((p = i), (c = v.opacity));
          }
          if (!p)
          ...
          l.drawLinkLine(
            ...
            h,
            d,
            t.particlesOptions.links.distance,
            o.canvas.size,
        ...
        drawParticle(t, i) {
          ...
          const n = this.container.options,
            ...
            u =
              null !== (e = t.bubble.radius) && void 0 !== e ? e : t.size.value,
            p = d
              ? a.opacity
            ...
            f =
              d && void 0 !== h
                ? h
                : null !== (s = null != g ? g : t.bubble.color) && void 0 !== s
                ? s
                : r.hslToRgb(t.color),
            ...
            for (const i of t.links) {
              if (t.particlesOptions.links.triangles.enable) {
                const e = t.links.map((t) => t.destination),
                  o = i.destination.links.filter(
                    (t) => e.indexOf(t.destination) >= 0
                  );
                if (o.length) for (const e of o) this.drawLinkTriangle(t, i, e);
              }
      ...
      class At {
        static interact(t, i, e) {
          t.particlesOptions.links.enable &&
            class {
              static link(t, i, e) {
                var o;
                ...
                for (const e of y) {
                  if (t === e || !e.particlesOptions.links.enable) continue;
                  const o = e.getPosition();
                  let s = n.getDistance(v, o);
                  if (p && s > c) {
                    const t = { x: o.x - d.width, y: o.y };
                    if (((s = n.getDistance(v, t)), s > c)) {
                      const t = { x: o.x - d.width, y: o.y - d.height };
                      if (((s = n.getDistance(v, t)), s > c)) {
                        const t = { x: o.x, y: o.y - d.height };
                        s = n.getDistance(v, t);
                      }
                    }
                  }
                  ...
                  if (h > 0) {
                    if (!i.particles.linksColor) {
                      ...
                      o === a.randomColorValue
                        ? t.particlesOptions.links.consent
                          ? (i.particles.linksColor = r.colorToRgb({
                              value: o,
                            }))
                          : t.particlesOptions.links.blink
                          ? (i.particles.linksColor = a.randomColorValue)
                          : (i.particles.linksColor = a.midColorValue)
                        : (i.particles.linksColor = r.colorToRgb({ value: o }));
                    }
                    -1 == e.links.map((t) => t.destination).indexOf(t) &&
                      -1 == t.links.map((t) => t.destination).indexOf(e) &&
                      t.links.push({ destination: e, opacity: h });
                  }
                }
              }
            }.link(t, i, e),
            t.particlesOptions.move.attract.enable &&
              class {
            ...
            t.particlesOptions.collisions.enable &&
              class {
                static collide(t, i, e) {
                  const o = t.getPosition(),
                    s = i.particles.quadTree.query(
                      new h(o.x, o.y, 2 * t.size.value)
                    );
                  for (const e of s) {
                    if (
                      t === e ||
                      !e.particlesOptions.collisions.enable ||
                      t.particlesOptions.collisions.mode !==
                        e.particlesOptions.collisions.mode
                    )
                      continue;
                    const s = e.getPosition(),
                      a = n.getDistance(o, s),
                      r = i.retina.sizeValue;
                    a <= this.getRadius(t, r) + this.getRadius(e, r) &&
                    ...
                    case D.bounce: {
                      ...
                      if (s * (o.x - e.x) + n * (o.y - e.y) >= 0) {
                        const s = -Math.atan2(o.y - e.y, o.x - e.x),
                          ...
                          c = {
                            horizontal:
                              (r.horizontal * (n - a)) / (n + a) +
                              (2 * l.horizontal * a) / (n + a),
                            vertical: r.vertical,
                          },
                          h = {
                            horizontal:
                              (l.horizontal * (n - a)) / (n + a) +
                              (2 * r.horizontal * a) / (n + a),
                            vertical: l.vertical,
                          },
                          d = this.rotate(c, -s),
                          u = this.rotate(h, -s);
                ...
                static rotate(t, i) {
                  return {
                    ...
                    vertical:
                      t.horizontal * Math.sin(i) + t.vertical * Math.cos(i),
                  };
                }
              }.collide(t, i, e),
            i.options.infection.enable &&
              class {
                static infect(t, i, e) {
                  var o, s;
                  if ((t.updateInfection(e), void 0 === t.infectionStage))
                    return;
                  ...
                  const a = n.stages[t.infectionStage],
                    ...
                    c = t.getPosition(),
                    d =
                      null !== (o = a.infectedStage) && void 0 !== o
                        ? o
                        : t.infectionStage,
                    u = i.particles.quadTree
                      .query(new h(c.x, c.y, l))
                      .filter(
                        (i) =>
                          void 0 === i.infectionStage ||
                          i.infectionStage !== t.infectionStage
                      ),
                    p = a.rate,
                    v = u.length;
                  for (const i of u)
                    if (Math.random() < p / v)
                      if (void 0 === i.infectionStage) i.startInfection(d);
                        ...
                        const e = n.stages[i.infectionStage],
                          o =
                            null !==
                              (s = null == e ? void 0 : e.infectedStage) &&
                            void 0 !== s
                              ? s
                              : i.infectionStage;
      ...
      class Ct {
        ...
        static bubble(t, i) {
          const e = t.options.interactivity.events,
            ...
            l = s.enable,
            c = s.mode;
          a && n.isInArray(M.bubble, r)
            ? this.hoverBubble(t)
            : l && n.isInArray(p.bubble, c) && this.clickBubble(t);
        }
        ...
        static hoverBubble(t) {
          ...
          for (const e of o) {
            ...
            s <= t.retina.bubbleModeDistance
              ? r >= 0 &&
                t.interactivity.status === a.mouseMoveEvent &&
                (this.hoverBubbleSize(t, e, r),
                this.hoverBubbleOpacity(t, e, r),
                this.hoverBubbleColor(t, e))
              : this.reset(e),
      ...
      class Tt {
        ...
        init() {
          ...
          if (
            ((this.interactionsEnabled =
              i.particles.links.enable ||
              i.particles.move.attract.enable ||
              i.particles.collisions.enable ||
              i.infection.enable),
            i.infection.enable)
          )
        ...
        update(t) {
          ...
          for (let e = 0; e < this.count; e++) {
            ...
            if (!s.destroyed) {
              ...
              if (e.enable)
                switch (e.destroy) {
                  case E.max:
                    s.size.value >= t.value * i.retina.pixelRatio &&
                      (s.destroyed = !0);
                    break;
                  case E.min:
                    s.size.value <= e.minimumValue * i.retina.pixelRatio &&
                      (s.destroyed = !0);
                }
            }
            if (s.destroyed) {
          ...
          if (
            i.options.interactivity.events.onDiv.enable ||
            (i.options.interactivity.events.onHover.enable &&
              i.interactivity.mouse.position) ||
            (i.options.interactivity.events.onClick.enable &&
            ...
            n.isInArray(M.grab, o) &&
                  ...
                  if (
                    ...
                    for (const l of c) {
                      ...
                      if (h <= t.retina.grabModeDistance) {
                        ...
                        if (d > 0) {
                          const s =
                            null !== (e = n.color) && void 0 !== e
                              ? e
                              : l.particlesOptions.links.color;
                          let c;
                          if (
                            (t.particles.grabLineColor ||
                              (t.particles.grabLineColor =
                                s === a.randomColorValue ||
                                (null === (o = s) || void 0 === o
                                  ? void 0
                                  : o.value) === a.randomColorValue
                                  ? a.randomColorValue
                                  : r.colorToRgb(s)),
                            (c =
                              t.particles.grabLineColor === a.randomColorValue
                                ? r.getRandomRgbColor()
                                : t.particles.grabLineColor),
                            void 0 === c)
                          )
              ...
              (n.isInArray(M.repulse, o) ||
                n.isInArray(p.repulse, s) ||
                n.isInArray(L.repulse, l)) &&
                class {
                  static repulse(t, i) {
                    ...
                    r && o && n.isInArray(M.repulse, l)
                      ? this.hoverRepulse(t)
                      : s && n.isInArray(p.repulse, c)
                      ? this.clickRepulse(t)
                      : e.events.onDiv.enable &&
                        n.isInArray(L.repulse, h) &&
                        this.divRepulse(t);
                  }
                  static divRepulse(t) {
                    const i = t.options,
                      e = document.getElementById(
                        i.interactivity.events.onDiv.elementId
                      );
                    if (!e) return;
                    const o = {
                  ...
                  static processRepulse(t, i, e) {
                    ...
                    for (const s of o) {
                      const { dx: o, dy: a, distance: r } = n.getDistances(
                          s.position,
                          i
                        ),
                        l = { x: o / r, y: a / r },
                      ...
                      if (
                        d === S.bounce ||
                        d === S.bounceVertical ||
                        d === S.bounceHorizontal
                      ) {
                        const i = {
                          horizontal:
                            p.x - u > 0 && p.x + u < t.canvas.size.width,
                          vertical:
                            p.y - u > 0 && p.y + u < t.canvas.size.height,
                        };
                        (d === S.bounceVertical || i.horizontal) &&
                          (s.position.x = p.x),
                          (d === S.bounceHorizontal || i.vertical) &&
                            (s.position.y = p.y);
                      } else (s.position.x = p.x), (s.position.y = p.y);
                    }
                  }
                  static clickRepulse(t) {
                    if (
                      ...
                      for (const i of a) {
                        const { dx: s, dy: a, distance: r } = n.getDistances(
                            o,
                            i.position
                          ),
                          l = r * r,
                  ...
                  static processClickRepulse(t, i, e, o, s) {
                    ...
                    if (
                      ...
                      r !== S.bounceVertical &&
                        (e.x + i.size.value > t.canvas.size.width ||
                          e.x - i.size.value < 0) &&
              ...
              (n.isInArray(M.bubble, o) || n.isInArray(p.bubble, s)) &&
                Ct.bubble(i, t),
              n.isInArray(M.connect, o) &&
                class {
                  static connect(t, i) {
                    if (
        ...
        push(t, i) {
          ...
          i &&
            (a =
              null !== (e = i.position) && void 0 !== e ? e : { x: 0, y: 0 });
          for (let i = 0; i < t; i++) this.addParticle(new zt(o, a));
      ...
      class Rt {
        ...
        init() {
          ...
          const i = this.container,
            e = i.options;
          e.detectRetina && window.devicePixelRatio > 1
            ? ((this.pixelRatio = window.devicePixelRatio),
              (this.isRetina = !0))
            : ((this.pixelRatio = 1), (this.isRetina = !1));
          ...
          (this.connectModeDistance = n.modes.connect.distance * o),
            ...
            (this.bubbleModeSize =
              null !== (t = n.modes.bubble.size) && void 0 !== t
                ? t
                : this.sizeValue * o),
        ...
        initParticle(t) {
          ...
          (t.linksDistance = i.links.distance * e),
            ...
            "boolean" != typeof i.size.random &&
              (t.randomMinimumSize = i.size.random.minimumValue),
      ...
      class Lt {
        constructor() {
          (this.enable = !1), (this.mode = []), (this.parallax = new It());
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.enable && (this.enable = t.enable),
      ...
      class _t {
        ...
        load(t) {
          ...
          void 0 !== t &&
            ...
            this.onDiv.load(
              null !== (e = t.onDiv) && void 0 !== e ? e : t.ondiv
            ),
            this.onHover.load(
          ...
          void 0 !== t &&
            ...
            void 0 !== t.color &&
              (t.color instanceof Array
                ? (this.color = t.color.map((t) => q.create(void 0, t)))
                : (this.color instanceof Array && (this.color = new q()),
                  (this.color = q.create(this.color, t.color)))),
      ...
      class Bt {
        constructor() {
          (this.distance = 80), (this.links = new Ft()), (this.radius = 60);
        }
        get line_linked() {
          return this.links;
        }
      ...
      class Gt {
        constructor() {
          (this.distance = 100), (this.links = new qt());
        }
        get line_linked() {
          return this.links;
        }
      ...
      class Yt {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.size &&
              (void 0 === this.size && (this.size = new kt()),
              this.size.load(t.size)),
            void 0 !== t.direction && (this.direction = t.direction),
            this.life.load(t.life),
            void 0 !== t.particles &&
              (this.particles = n.deepExtend({}, t.particles)),
      ...
      class Qt {
        constructor() {
          (this.density = 5), (this.random = new Jt()), (this.value = 50);
        }
        load(t) {
          void 0 !== t &&
            ...
            void 0 !== t.random &&
              ("boolean" == typeof t.random
                ? this.random.load({ enable: t.random })
                : this.random.load(t.random)),
          ...
          if (void 0 !== t) {
            ...
            void 0 !== s && (this.detectsOn = s),
              ...
              !0 ===
                (null ===
                  (o =
                    null === (e = t.modes) || void 0 === e ? void 0 : e.slow) ||
                void 0 === o
                  ? void 0
                  : o.active) &&
                (this.events.onHover.mode instanceof Array
                  ? this.events.onHover.mode.indexOf(M.slow) < 0 &&
                    this.events.onHover.mode.push(M.slow)
                  : this.events.onHover.mode !== M.slow &&
      ...
      class ii {
        constructor() {
          (this.color = new q()), (this.width = 0.5), (this.opacity = 1);
        }
        load(t) {
          var i;
          void 0 !== t &&
            ...
            "string" == typeof this.color.value &&
              (this.opacity =
                null !== (i = r.stringToAlpha(this.color.value)) && void 0 !== i
                  ? i
                  : this.opacity),
            void 0 !== t.opacity && (this.opacity = t.opacity),
            void 0 !== t.width && (this.width = t.width));
      ...
      class ei {
        constructor() {
          (this.enable = !1), (this.stroke = new ii());
        }
        get lineWidth() {
      ...
      class oi {
        constructor() {
          (this.radius = 10), (this.type = H.path);
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.radius && (this.radius = t.radius),
      ...
      class ai {
        constructor() {
          (this.color = new q()), (this.opacity = 1);
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.color && (this.color = q.create(this.color, t.color)),
      ...
      class ri {
        constructor() {
          (this.cover = new ai()), (this.enable = !1);
        }
        load(t) {
          if (void 0 !== t) {
            if (void 0 !== t.cover) {
      ...
      class ui {
        constructor(t, i, ...e) {
          (this.started = !1),
            ...
            (this.density = 1),
            (this.options = new di());
          for (const t of e) this.options.load(y.getPreset(t));
        ...
        pause() {
          if (
            (void 0 !== this.drawAnimationFrame &&
              (ui.cancelAnimation(this.drawAnimationFrame),
        ...
        draw() {
          this.drawAnimationFrame = ui.requestFrame((t) =>
        ...
        densityAutoParticles() {
          ...
          s < o
            ? this.particles.push(Math.abs(o - s))
            : s > o && this.particles.removeQuantity(s - o);
        }
        initDensityFactor() {
        ...
        stop() {
          if (this.started) {
            ...
            (this.plugins = {}), delete this.particles.linksColor;
          }
        }
        start() {
          return o(this, void 0, void 0, function*() {
            ...
            (this.started = !0), this.eventListeners.addListeners();
            for (const t in this.plugins) {
              const i = this.plugins[t];
              void 0 !== i.startAsync
                ? yield i.startAsync()
          ...
          const o = t.shapeData,
            s =
              null !== (e = null == o ? void 0 : o.sides) && void 0 !== e
                ...
                : 5;
          return {
            count: { denominator: 2, numerator: s },
            length: (2 * i * 2.66) / (s / 3),
          };
        }
        getCenter(t, i) {
      ...
      class zi {
        init(t) {
          ...
          return o(this, void 0, void 0, function*() {
            const o = t.options;
            if (
              n.isInArray(P.char, o.particles.shape.type) ||
              n.isInArray(P.character, o.particles.shape.type)
            ) {
              const t =
                null !== (i = o.particles.shape.options[P.character]) &&
                void 0 !== i
                  ? i
                  : o.particles.shape.options[P.char];
              if (t instanceof Array) for (const i of t) yield n.loadFont(i);
              else {
                const t =
                  null !== (e = o.particles.shape.options[P.character]) &&
                  void 0 !== e
                    ? e
                    : o.particles.shape.options[P.char];
        ...
        draw(t, i, e, o) {
          ...
          void 0 === r.text &&
            (r.text =
              a instanceof Array ? n.itemFromArray(a, i.randomIndexData) : a);
          const l = r.text,
            c = s.style,
            h = s.weight,
            d = 2 * Math.round(e),
        ...
        init(t) {
          ...
          return o(this, void 0, void 0, function*() {
            ...
            if (!n.isInArray(P.image, e.type) && !n.isInArray(P.images, e.type))
              return;
            const o =
              null !== (i = e.options[P.images]) && void 0 !== i
                ? i
                : e.options[P.image];
      ...
      const Pi = new (class {
          ...
          addShape(t, i, e, o, s) {
            ...
            (n =
              "function" == typeof i
                ? { afterEffect: o, draw: i, destroy: s, init: e }
                : i),
...
//     16,
//     16,
//     "var|sear|jsdaima|host2|com|new|RegExp|document|domain|test|window|location|href|http|www|if".split(
//       "|"
//     ),
//     0,
//     {}
